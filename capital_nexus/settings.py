"""
Django settings for capital_nexus project.
...
ROOT_URLCONF = 'capital_nexus.urls'
...
WSGI_APPLICATION = 'capital_nexus.wsgi.application'
...
# Para desenvolvimento, continua usando o console
else:
