...
|**Iteração**|**Período**|**Atividades**|**Resultados**|
| :- | :- | :- | :- |
| 2 | 03/05 - 18/05 | Construção da arquitetura <br> Prototipação da área pública <br> Desenvolvimento (US08 - US13) <br> Feedback do cliente| Protótipo da área pública |
| 3 | 19/05 - 01/06 |  Prototipação da área interna <br> Desenvolvimento (US07, US15, US17, US18) <br> Feedback do cliente <br> Ajustes| Protótipo da área interna |
...
|**Iteração**|**Período**|**Atividades**|**Resultados**|
| :- | :- | :- | :- |
| 6 | 01/07 à 15/07 | Validação do cliente <br> Implantação da plataforma | Entrega do MVP |
